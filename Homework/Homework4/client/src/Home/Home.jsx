...
var content = ["a HCMUS student.    ", "a BA.    "];
		...
		return (
			<div className="home-container row d-flex flex-xl-row-reverse ps-4 pt-0 pb-3">
				<div id="home-content" className="pt-5">
					...
					<h1 className="mb-0">
						Hi, I'm <span className="bold-name">Hưng Khang</span>
					</h1>
					...
					<div className="introduce">
						<p className="intro">
							I'm living in Ho Chi
							Minh city and studying Information Technology at Ho Chi
							Minh University of Science. My major is Information System.
						</p>
					</div>
				</div>
			</div>
